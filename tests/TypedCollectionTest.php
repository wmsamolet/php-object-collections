...
final class TypedCollectionTest extends TestCase
{
    ...
    public function testCreationThroughTheConstructor(): void
    {
        ...
        $collection = new TypedCollection(AbstractTypedCollection::TYPE_INTEGER, $generatedValueList);
    ...
    {
        $generatedValueList = $this->generateValueList();
        $collection = new TypedCollection(AbstractTypedCollection::TYPE_INTEGER);
    ...
    {
        $generatedValueList = $this->generateValueList();
        $collection = (new TypedCollection(AbstractTypedCollection::TYPE_INTEGER))->addList($generatedValueList);
    ...
    {
        $generatedValueList = $this->generateValueList();
        $collection = (new TypedCollection(AbstractTypedCollection::TYPE_INTEGER))->setList($generatedValueList);
    ...
    public function testBatchCallback(): void
    {
        ...
        $collection->setBatchCallback(
            function ($size, callable $defaultCallback, TypedCollection $that) use ($newValue) {
                $that->add($newValue);
    ...
    public function testSetInvalidItemValue(): void
    {
        ...
        (new TypedCollection(AbstractTypedCollection::TYPE_INTEGER))->set(0, '1');
    }
